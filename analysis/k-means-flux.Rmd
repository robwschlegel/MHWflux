...
Meh. The analysis works but it shows that there is little difference between the regions. With the exception of the Soctian Shelf being a bit different than the Mid-Atlantic Bight. We could already see in the correlation results that the Scotial Shelf was a bit different, so these underwhelming results are at least consistent with the story thus far.
