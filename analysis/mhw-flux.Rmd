...
```{r, echo=FALSE}
res_table <- data.frame(variable = c("Air temperature", "Total precipitation", "Total evaporation", "Air Northerly", "Air Easterly",
                                     "Mean sea level pressure", "Mean sea level pressure (cumulative)", "Sea surfce height", 
                                     "Current Northerly", "Current Easterly",  "Sea surface salinity", "Mixed layer depth",
                                     "Bottom temperature", "Latent heat flux", "Sensible heat flux", "Longwave radiation",
                                     "Shortwave radiation", "Net heat flux"),
                        abreviation = c("t2m", "tp", "e", "v10", "u10", "msl", "msl_cum", "ssh", "v", "u", "sss", "mld", "bottomT",
                                        "mslhf_mld", "msshf_mld", "msnlwrf_mld", "msnswrf_mld", "qnet_mld"),
                        onset = c("Even throughout",
                                  "Normal with slight positive",
                                  "Even throughout",
                                  "Three hump",
                                  "Slight positive",
                                  "Strong negative with positive tail",
                                  "Strong negative and positive",
                                  "Even throughout",
                                  "Normal but flat",
                                  "Normal with positive tail"),
                        full = c("Slight positive",
                                 "Normal distribution",
                                 "Normal distribution",
                                 "Normal distribution",
                                 "Normal distribution",
                                 "Slight negative to normal",
                                 "Normal but flat",
                                 "Slight negative",
                                 "Normal distribution",
                                 "Normal distribution"),
                        decline = c("Strong positive",
                                    "Even throughout",
                                    "Strong positive",
                                    "Three hump",
                                    "Slight negative",
                                    "Even with positive tail",
                                    "Strong positive with small negative tail",
                                    "Positive tail",
                                    "Positive with small negative tail",
                                    "Slight three hump"),
                        season = c("Autumn always strong positive for decline. Spring decline has large range.",
                                   "Autumn and Winter slightly more positive with Spring decline usually negative.",
                                   "Spring is the only season that isn't mostly positive for decline.",
                                   "Large spread for all seasons with Autumn tending towards positive for onset and decline.",
                                   "Least amount of range in Autumn onset.",
                                   "Autumn is much more negative for onset and decline. Spring and Summer onset tend positive.",
                                   "Full range in onset and decline for all seasons except positive Spring onset. Autumn onset tends negative.",
                                   "Not much difference. Winter onset tends more negative.",
                                   "Autumn decline tends positive while Summer tends negative."),
                        region = c("Stronger positive for GSL and MAB.",
                                   "Nothing clear. SS and NFS decline most often r ~= 0.",
                                   "SS is the only region not mostly positive for decline.",
                                   "Not much difference. NFS tends a bit more towards positive onset and decline than others.",
                                   "GM tends to have the least range and be the most negative for onset and decline.",
                                   "GM and NFS more positive for decline.",
                                   "Full range for all. GM decline tends positive. CBS onset tends negative, NFS and SS onset tend positive.",
                                   "GM onset and decline tend more positive.",
                                   "NFS onset tends most positive."),
                        overall = c("Much clearer relationship for decline than onset.",
                                    "Meh.",
                                    "Important for the decline of events, except often in Spring.",
                                    "There are some signals in there, but they are not clear.",
                                    "Slight positive onset and slight negative decline imply this vaguely shows a thermal gradient.",
                                    "Decrease in MSLP is often important for the onset of events",
                                    "Stronger signals than for MSLP non-cumulative.",
                                    "The strong positive signal for decline implies a height anomaly (i.e. an eddy) leaving the area.",
                                    "Meh.",
                                    "Possibly something there for onset of events in NFS."),
                        story = c(TRUE,
                                  FALSE,
                                  TRUE,
                                  FALSE,
